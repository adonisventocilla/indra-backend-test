...
container
  .bind<Repository<Starship>>("STARSHIP_REPOSITORY")
  .toDynamicValue(() => AppDataSource.getRepository(Starship))
container
  .bind<Repository<StarshipPilot>>("STARSHIP_PILOT_REPOSITORY")
  .toDynamicValue(() => AppDataSource.getRepository(StarshipPilot))
container
  .bind<Repository<StarshipMovie>>("STARSHIP_MOVIE_REPOSITORY")
  .toDynamicValue(() => AppDataSource.getRepository(StarshipMovie))
